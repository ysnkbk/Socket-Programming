...
public class Client {
    ...
    public void sendUserName() {
        try {
            ...
            System.out.println("User name hatasi");
        }
    }
    ...
    public void publicKey() {
        try {
            ...
            System.out.println("public key hatası");
        }
    }
        ...
        try {
            ...
            while (socket.isConnected()) {
                ...
                if (messageToSend.trim().charAt(0) == '@') {
                    ...
                    String path = "C:\\Users\\Yasin\\Desktop\\New folder\\JavaDeneme\\PublicKey\\" + receiverName[0];
